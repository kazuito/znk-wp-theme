...
<header class="article-header entry-header">
	...
	breadcrumb(); //パンくず
	?>
	<h1 class="entry-title single-title"><?php the_title(); //タイトル
																				?></h1>
	...
	?>
		...
		<label class="fab-btn <?php if (get_option('extended_fab')) {
														echo 'extended-fab main-c';
													} else {
														echo 'accent-bc';
													} ?>" for="fab"><i class="fa fa-share-alt"></i></label>
