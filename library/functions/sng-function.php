  ...
  function sng_normal_card(){ ?>
    <article class="cardtype__article">
        <a class="cardtype__link" href="<?php the_permalink() ?>">
          <div class="cardtype__img" style="position: relative">
            <img src="<?php echo featured_image_src('thumb-520'); ?>" alt="<?php echo get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true); ?>">
			<?php 
		    ...
		    ?>
			<div style="position:absolute; bottom: 1rem; right: 1rem; background: black; color: white; font-weight: bold; padding: 0 4px; border-radius: 4px;">
    ...
    <article class="sidelong__article">
        <a class="sidelong__link" href="<?php the_permalink() ?>">
          <p class="sidelong__img">
            <img src="<?php echo featured_image_src('thumb-160'); ?>" alt="<?php echo get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true); ?>">
          </p>
